...
@class PanigaleDBSnapshot;
@class PanigaleDBWriteBatch;
...
/**
 A class method that returns a LevelDBOptions struct, which can be modified to fine tune leveldb
 */
